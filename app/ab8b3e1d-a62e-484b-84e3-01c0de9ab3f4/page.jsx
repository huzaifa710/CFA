      ...
      <div className="bg-[#E5E5E5] ">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col items-center justify-center">
            <img src={"../../badge.png"} className="md:w-96 w-60 " />
          </div>
        </div>
      </div>
      <div className="flex flex-col lg:flex-row pt-6 md:pt-12 md:pb-16 pb-10 md:px-4 gap-8 w-[90%] bg-white text-gray-800 max-w-screen-xl mx-auto">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-4 text-sm pl-4 pt-1 pb-5">
            ...
            <a
              href="https://api.accredible.com/v1/credential/generate_baked_badge?credential_id=118145335&_gl=1*1pyr2sa*_gcl_au*MzY0NDE4Mjc5LjE3NDgzMTk2NjA.*_ga*NTU4MzE3ODYuMTc0ODMxOTY2MQ..*_ga_FSDJZHHBH0*czE3NTA1MTczNTMkbzEwJGcxJHQxNzUwNTIxMzI5JGo1MiRsMCRoMTYyNTY3MTUyNA.."
              target="_blank"
            >
              <button className="text-black/85 flex items-center cursor-pointer gap-2">
          ...
          >
            ...
            passed Level II of the CFA® Program. The CFA Program is a three-part
            ...
            curriculum for the Level II exam is focused on the application of
                      ...
                      <div className="flex items-start gap-3 mb-6 mt-20">
                        ...
                        <div>
                          <div className="text-lg tracking-wide mb-1">
                            This <strong>CFA Program Level II</strong>{" "}
